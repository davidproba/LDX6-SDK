...
/**
 * Provides the local service interface for BeaconDDL. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author David Proba
 * @see BeaconDDLLocalServiceUtil
...
public interface BeaconDDLLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link BeaconDDLLocalServiceUtil} to access the beacon d d l local service. Add custom service methods to {@link com.liferay.sample.service.impl.BeaconDDLLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
