...
<%
	...
	List<Layout> loclayouts = LayoutLocalServiceUtil.getLayouts(themeDisplay.getScopeGroupId(), false);
%>
<ul class="proNav">
<%
	String cURL = themeDisplay.getURLCurrent();
	for(Layout l:loclayouts) {
		String tURL = String.format("/web%s%s", group.getFriendlyURL(), l.getFriendlyURL());
		String actcss = "";
		String iconcss = "";
		...
		if(l.getFriendlyURL(Locale.ENGLISH).contains("articles")) {
			iconcss = "icon-file";
		}
...
%>	
	<%@ include file="/html/teamsitenavigation/actions.jspf" %>
</ul>