	...
	socialActivities.delegate(
		...
		function(event) {
			...
			if (commentsList.attr('loaded')) {
				if(commentsContainer.get('offsetHeight')>35) {
					commentsContainer.transition(
					{
						duration: 0.5,
						easing: 'ease-in-out',
						height: '0px'
					...
					commentsContainer.setStyle('height','auto');
					tmpHeight = commentsContainer.getComputedStyle('height');
					commentsContainer.setStyle('height','0px');
					commentsContainer.transition(
					{
						duration: 0.5,
						easing: 'ease-in-out',
