...
/**
 * Provides the local service interface for Wallpost. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author David Proba
 * @see WallpostLocalServiceUtil
...
public interface WallpostLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link WallpostLocalServiceUtil} to access the wallpost local service. Add custom service methods to {@link com.liferay.ldx6demo.teamsitewall.service.impl.WallpostLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
