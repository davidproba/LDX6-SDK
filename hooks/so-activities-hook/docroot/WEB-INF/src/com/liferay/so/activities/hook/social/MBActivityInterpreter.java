...
public class MBActivityInterpreter extends SOSocialActivityInterpreter {
	...
	protected String getTitlePattern(String groupName, SocialActivity activity)
		...
		if ((activity.getType() ==
			...
			titlePattern = "replied-to-x-forum-post";
					...
					SocialActivityKeyConstants.MB_ADD_MESSAGE) {
			MBMessage mbm = MBMessageLocalServiceUtil.getMBMessage(activity.getClassPK());
			String body = mbm.getBody();
			if(mbm.isFormatBBCode()) {
				body = BBCodeTranslatorUtil.getHTML(body);
			}
			return HtmlUtil.escape(HtmlUtil.extractText(body));
		}
		else {
	...
	protected String getTitlePattern(
		...
		if (activitySet.getType() ==
				SocialActivityKeyConstants.MB_ADD_MESSAGE) {
					MBMessage mbm = MBMessageLocalServiceUtil.getMBMessage(activitySet.getClassPK());
					String body = mbm.getBody();
					if(mbm.isFormatBBCode()) {
						body = BBCodeTranslatorUtil.getHTML(body);
					}
